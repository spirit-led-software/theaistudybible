...
export const Route = createFileRoute('/_with-footer/_with-header/privacy')({
  head: () => {
    ...
    <div className='container mx-auto max-w-4xl px-4 py-12'>
      ...
      <div className='mt-12 space-y-12'>
        ...
        <section>
          ...
          <H3 className='mb-2'>Personal Information You Disclose to Us</H3>
          <P>
          ...
          <H3 className='mt-4 mb-2'>Information Automatically Collected</H3>
          <P>
            We automatically collect certain information when you visit, use, or navigate the
            website. This information does not reveal your specific identity but may include device
        ...
        <section>
          ...
          <List>
            ...
            <ListItem>
              ...
              or safety of The AI Study Bible, our customers, or others
            </ListItem>
          </List>
        </section>
        ...
        <section>
          ...
          <List>
            <ListItem>The right to access and receive a copy of your personal information</ListItem>
        ...
        <section>
          <H2 className='mb-4'>9. California Privacy Rights</H2>
          <P>
        ...
        <section>
          ...
          <P className='mt-2'>
            <strong className='font-goldman'>The AI Study Bible</strong>
            <br />
            Email:{' '}
            <a href='mailto:privacy@theaistudybible.com' className='text-primary hover:underline'>
