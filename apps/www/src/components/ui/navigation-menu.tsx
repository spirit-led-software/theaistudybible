  ...
  return (
    <NavigationMenuPrimitive.Icon aria-hidden='true'>
      <svg
        ...
        class='group-data-[orientation=vertical]/menu:-rotate-90 relative top-px ml-1 size-3 transition duration-200 group-data-expanded/trigger:group-data-[orientation=vertical]/menu:rotate-90 group-data-expanded/trigger:rotate-180'
      >
        <path d='M6 9l6 6l6 -6' />
      </svg>
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      <NavigationMenuPrimitive.Content
        class={cn(
          // base settings
          'pointer-events-none absolute top-0 left-0 box-border p-4 focus:outline-hidden data-expanded:pointer-events-auto',
