    ...
    <>
      ...
      <div class='container mx-auto max-w-4xl px-4 py-12'>
        ...
        <div class='mt-12 space-y-12'>
          ...
          <section>
            <H2 class='mb-4'>2. Description of Service</H2>
            <P>
          ...
          <section>
            <H2 class='mb-4'>4. User Conduct</H2>
          ...
          <section>
            <H2 class='mb-4'>5. Intellectual Property</H2>
            <P>
            ...
            <H3 class='mt-4 mb-2'>5.1 Limited License</H3>
            <P>
          ...
          <section>
            <H2 class='mb-4'>6. Disclaimer of Warranties</H2>
            <P>
          ...
          <section>
            <H2 class='mb-4'>8. Indemnification</H2>
            <P>
              ...
              damages, losses, and expenses arising out of or in any way connected with your access
              to or use of the Service or your violation of these Terms.
            </P>
          </section>

          <section>
            <H2 class='mb-4'>9. Dispute Resolution</H2>
            <P>
              ...
              rules. The arbitration shall be conducted in [Your State], and the arbitrator's
          ...
          <section>
            <H2 class='mb-4'>11. Changes to Terms</H2>
            <P>
              We reserve the right to modify these Terms at any time. We will notify users of any
              significant changes via email or through our website. Your continued use of the
              Service after such modifications constitutes your acceptance of the updated Terms.
            </P>
          </section>

          <section>
            <H2 class='mb-4'>12. Termination</H2>
            <P>
          ...
          <section>
            <H2 class='mb-4'>13. Severability</H2>
            <P>
          ...
          <section>
            <H2 class='mb-4'>14. Entire Agreement</H2>
            <P>
              These Terms constitute the entire agreement between you and The AI Study Bible
              regarding the Service and supersede all prior agreements and understandings.
            </P>
          </section>

          <section>
            <H2 class='mb-4'>15. Contact Us</H2>
            <P>
              If you have any questions about these Terms, please contact us at{' '}
              <a href='mailto:terms@theaistudybible.com' class='text-primary hover:underline'>
