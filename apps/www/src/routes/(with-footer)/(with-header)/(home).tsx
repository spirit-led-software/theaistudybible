...
import { BookOpen, Clock, MessageCircle, Search, Shield, Star } from 'lucide-solid';
...
export default function HomePage() {
  ...
  return (
    <Show when={!isSignedIn() && !bibleStore.chapter} fallback={<Navigate href='/bible' />}>
      <div class='flex min-h-full w-full flex-col'>
        {/* Hero Section */}
        <div class='relative w-full overflow-hidden py-8 sm:py-12 md:py-16 lg:py-24'>
          {/* Add ambient background */}
          <div class='-z-10 absolute inset-0'>
            {/* Base gradient */}
            <div class='absolute inset-0 bg-gradient-to-tr from-primary/10 via-accent/10 to-background' />

            {/* Larger, more visible blurred circles */}
            <div class='-right-1/4 absolute top-0 h-[500px] w-[500px] rounded-full bg-[#A2EEFB]/30 blur-[128px]' />
            <div class='-left-1/4 absolute top-1/3 h-[500px] w-[500px] rounded-full bg-[#F9CDF0]/30 blur-[128px]' />
            <div class='absolute top-1/4 right-1/3 h-[400px] w-[400px] rounded-full bg-[#6FECF7]/20 blur-[96px]' />
          </div>
          ...
          <div class='container mx-auto px-4'>
            <div class='grid grid-cols-2 gap-8 md:grid-cols-4'>
              <div class='flex flex-col items-center justify-center text-center'>
                ...
                <Muted class='text-xs'>More Coming Soon!</Muted>
              </div>
              <div class='flex flex-col items-center justify-center text-center'>
                <MessageCircle class='mb-2 h-6 w-6 text-primary' />
                <H3 class='font-bold'>24/7</H3>
                <P class='text-muted-foreground text-sm'>AI Assistance</P>
              </div>
              <div class='flex flex-col items-center justify-center text-center'>
                <Clock class='mb-2 h-6 w-6 text-primary' />
                <H3 class='font-bold'>2 Min</H3>
                <P class='text-muted-foreground text-sm'>Quick Setup</P>
              </div>
              <div class='flex flex-col items-center justify-center text-center'>
                <Shield class='mb-2 h-6 w-6 text-primary' />
        ...
        <div class='bg-primary/5 py-16'>
          <div class='container mx-auto px-4 text-center'>
            ...
            <P class='mb-8 text-muted-foreground'>
              Join our growing community of early adopters transforming their Scripture study with
              AI
            </P>
