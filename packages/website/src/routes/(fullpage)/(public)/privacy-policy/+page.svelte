...
<ul>
  ...
  <li>
    <p>
      <strong>Application</strong> refers to RevelationsAI, the software program provided by the Company.
    </p>
  </li>
  <li>
    <p>
      <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
      or &quot;Our&quot; in this Agreement) refers to RevelationsAI.
    </p>
  </li>
  <li>
    <p>
  ...
  <li>
    <p>
      <strong>Website</strong> refers to RevelationsAI, accessible from
      <a href="https://revelationsai.com" rel="external nofollow noopener" target="_blank"
        >https://revelationsai.com</a
      >
    </p>
  </li>
  <li>
...
<ul>
  <li>By email: support@revelationai.com</li>
</ul>

<style lang="postcss">
  h1 {
    @apply mb-2 mt-10 text-center text-2xl font-medium;
  }

  h2 {
    @apply mb-1 mt-2 text-xl font-medium;
  }
