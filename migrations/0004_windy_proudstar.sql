...
ALTER TABLE `user_generated_images_to_source_documents` ALTER COLUMN "source_document_id" TO "source_document_id" text NOT NULL REFERENCES source_documents(id) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
