DROP INDEX IF EXISTS "bible_contributors_uid_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_countries_iso_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_languages_iso_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_languages_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_languages_name_local_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_languages_script_code_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_languages_script_direction_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_rights_admins_uid_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_rights_holders_uid_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bible_rights_holders_abbr_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_abbreviation_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_abbreviation_local_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_name_local_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_contributors_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_contributors_contributor_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_countries_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_countries_country_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_languages_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_languages_language_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_rights_admins_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_rights_admins_rights_admin_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_rights_holders_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "bibles_to_rights_holders_rights_holder_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_previous_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_next_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_number_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_code_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "books_abbreviation_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapter_bookmarks_unique_user_chapter_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapter_bookmarks_chapter_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapter_bookmarks_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapter_notes_chapter_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapter_notes_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_book_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_previous_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_next_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_code_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_number_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_to_source_documents_chapter_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chapters_to_source_documents_source_document_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chats_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chats_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_name_key";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_type_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_metadata_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_last_manual_sync_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_last_automatic_sync_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_to_source_documents_data_source_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "data_sources_to_source_documents_source_document_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_images_devotion_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_images_caption_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_reactions_unique_user_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_reactions_devotion_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_reactions_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotion_reactions_reaction_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotions_topic_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotions_created_at_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotions_failed_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotions_to_source_documents_devotion_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "devotions_to_source_documents_source_document_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "forgotten_password_codes_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "index_operation_data_source_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "index_operation_status_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "index_operation_metadata_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "message_reactions_unique_user_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "message_reactions_message_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "message_reactions_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_chat_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_origin_message_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_role_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_content_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_finish_reason_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_to_source_documents_message_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "messages_to_source_documents_source_document_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "passwords_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "reading_sessions_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "reading_sessions_start_time_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "reading_sessions_end_time_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "roles_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "sessions_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "chat_share_options_chat_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_credits_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_message_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_user_prompt_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_failed_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_image_reaction_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_reactions_user_generated_image_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_reactions_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_reactions_reaction_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_to_source_documents_user_generated_image_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "user_generated_images_to_source_documents_source_document_id_idx";--> statement-breakpoint
...
DROP INDEX IF EXISTS "users_preferred_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "users_to_roles_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "users_to_roles_role_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_bookmarks_unique_user_verse_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_bookmarks_verse_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_bookmarks_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_highlights_unique_user_verse_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_highlights_verse_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_highlights_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_notes_verse_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verse_notes_user_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_bible_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_book_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_chapter_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_previous_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_next_id_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_code_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_name_idx";--> statement-breakpoint
DROP INDEX IF EXISTS "verses_number_idx";--> statement-breakpoint
