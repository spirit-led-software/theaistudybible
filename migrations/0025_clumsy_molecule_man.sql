...
INSERT INTO `__new_bible_contributors`("created_at", "updated_at", "uid", "name", "content", "publication", "management", "finance", "qa") SELECT "created_at", "updated_at", "uid", "name", "content", "publication", "management", "finance", "qa" FROM `bible_contributors`;--> statement-breakpoint
DROP TABLE `bible_contributors`;--> statement-breakpoint
ALTER TABLE `__new_bible_contributors` RENAME TO `bible_contributors`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bible_countries`("created_at", "updated_at", "iso", "name") SELECT "created_at", "updated_at", "iso", "name" FROM `bible_countries`;--> statement-breakpoint
DROP TABLE `bible_countries`;--> statement-breakpoint
ALTER TABLE `__new_bible_countries` RENAME TO `bible_countries`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bible_languages`("created_at", "updated_at", "iso", "name", "name_local", "script", "script_code", "script_direction", "ldml", "rod", "numerals") SELECT "created_at", "updated_at", "iso", "name", "name_local", "script", "script_code", "script_direction", "ldml", "rod", "numerals" FROM `bible_languages`;--> statement-breakpoint
DROP TABLE `bible_languages`;--> statement-breakpoint
ALTER TABLE `__new_bible_languages` RENAME TO `bible_languages`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bible_rights_admins`("created_at", "updated_at", "uid", "name", "url") SELECT "created_at", "updated_at", "uid", "name", "url" FROM `bible_rights_admins`;--> statement-breakpoint
DROP TABLE `bible_rights_admins`;--> statement-breakpoint
ALTER TABLE `__new_bible_rights_admins` RENAME TO `bible_rights_admins`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bible_rights_holders`("created_at", "updated_at", "uid", "name", "name_local", "abbr", "url") SELECT "created_at", "updated_at", "uid", "name", "name_local", "abbr", "url" FROM `bible_rights_holders`;--> statement-breakpoint
DROP TABLE `bible_rights_holders`;--> statement-breakpoint
ALTER TABLE `__new_bible_rights_holders` RENAME TO `bible_rights_holders`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles`("created_at", "updated_at", "abbreviation", "abbreviation_local", "name", "name_local", "description", "copyright_statement", "ready_for_publication") SELECT "created_at", "updated_at", "abbreviation", "abbreviation_local", "name", "name_local", "description", "copyright_statement", "ready_for_publication" FROM `bibles`;--> statement-breakpoint
DROP TABLE `bibles`;--> statement-breakpoint
ALTER TABLE `__new_bibles` RENAME TO `bibles`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles_to_contributors`("bible_abbreviation", "contributor_uid") SELECT "bible_abbreviation", "contributor_uid" FROM `bibles_to_contributors`;--> statement-breakpoint
DROP TABLE `bibles_to_contributors`;--> statement-breakpoint
ALTER TABLE `__new_bibles_to_contributors` RENAME TO `bibles_to_contributors`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles_to_countries`("bible_abbreviation", "country_iso") SELECT "bible_abbreviation", "country_iso" FROM `bibles_to_countries`;--> statement-breakpoint
DROP TABLE `bibles_to_countries`;--> statement-breakpoint
ALTER TABLE `__new_bibles_to_countries` RENAME TO `bibles_to_countries`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles_to_languages`("bible_abbreviation", "language_iso") SELECT "bible_abbreviation", "language_iso" FROM `bibles_to_languages`;--> statement-breakpoint
DROP TABLE `bibles_to_languages`;--> statement-breakpoint
ALTER TABLE `__new_bibles_to_languages` RENAME TO `bibles_to_languages`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles_to_rights_admins`("bible_abbreviation", "rights_admin_uid") SELECT "bible_abbreviation", "rights_admin_uid" FROM `bibles_to_rights_admins`;--> statement-breakpoint
DROP TABLE `bibles_to_rights_admins`;--> statement-breakpoint
ALTER TABLE `__new_bibles_to_rights_admins` RENAME TO `bibles_to_rights_admins`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_bibles_to_rights_holders`("bible_abbreviation", "rights_holder_uid") SELECT "bible_abbreviation", "rights_holder_uid" FROM `bibles_to_rights_holders`;--> statement-breakpoint
DROP TABLE `bibles_to_rights_holders`;--> statement-breakpoint
ALTER TABLE `__new_bibles_to_rights_holders` RENAME TO `bibles_to_rights_holders`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_books`("created_at", "updated_at", "bible_abbreviation", "previous_code", "next_code", "number", "code", "abbreviation", "short_name", "long_name") SELECT "created_at", "updated_at", "bible_abbreviation", "previous_code", "next_code", "number", "code", "abbreviation", "short_name", "long_name" FROM `books`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_chapter_bookmarks`("created_at", "updated_at", "bible_abbreviation", "chapter_code", "user_id") SELECT "created_at", "updated_at", "bible_abbreviation", "chapter_code", "user_id" FROM `chapter_bookmarks`;--> statement-breakpoint
DROP TABLE `chapter_bookmarks`;--> statement-breakpoint
ALTER TABLE `__new_chapter_bookmarks` RENAME TO `chapter_bookmarks`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_chapter_notes`("created_at", "updated_at", "bible_abbreviation", "chapter_code", "user_id", "content") SELECT "created_at", "updated_at", "bible_abbreviation", "chapter_code", "user_id", "content" FROM `chapter_notes`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_chapters`("created_at", "updated_at", "bible_abbreviation", "book_code", "previous_code", "next_code", "code", "name", "number", "content") SELECT "created_at", "updated_at", "bible_abbreviation", "book_code", "previous_code", "next_code", "code", "name", "number", "content" FROM `chapters`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_chapters_to_source_documents`("bible_abbreviation", "chapter_code", "source_document_id") SELECT "bible_abbreviation", "chapter_code", "source_document_id" FROM `chapters_to_source_documents`;--> statement-breakpoint
...
ALTER TABLE `user_settings` ADD `preferred_bible_abbreviation` text REFERENCES bibles(abbreviation);--> statement-breakpoint
...
ALTER TABLE `user_settings` DROP COLUMN `preferred_bible_id`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_verse_bookmarks`("created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id") SELECT "created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id" FROM `verse_bookmarks`;--> statement-breakpoint
DROP TABLE `verse_bookmarks`;--> statement-breakpoint
ALTER TABLE `__new_verse_bookmarks` RENAME TO `verse_bookmarks`;--> statement-breakpoint
CREATE INDEX `verse_bookmarks_bible_abbreviation_idx` ON `verse_bookmarks` (`bible_abbreviation`);--> statement-breakpoint
CREATE INDEX `verse_bookmarks_verse_code_idx` ON `verse_bookmarks` (`verse_code`);--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_verse_highlights`("created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id", "color") SELECT "created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id", "color" FROM `verse_highlights`;--> statement-breakpoint
DROP TABLE `verse_highlights`;--> statement-breakpoint
ALTER TABLE `__new_verse_highlights` RENAME TO `verse_highlights`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_verse_notes`("created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id", "content") SELECT "created_at", "updated_at", "bible_abbreviation", "verse_code", "user_id", "content" FROM `verse_notes`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_verses`("created_at", "updated_at", "bible_abbreviation", "book_code", "chapter_code", "previous_code", "next_code", "code", "name", "number", "content") SELECT "created_at", "updated_at", "bible_abbreviation", "book_code", "chapter_code", "previous_code", "next_code", "code", "name", "number", "content" FROM `verses`;--> statement-breakpoint
...
CREATE INDEX `verses_previous_code_idx` ON `verses` (`previous_code`);--> statement-breakpoint
